...
import 'selecionarDocumentos.dart';

class CodigosCompartilhamento extends StatefulWidget {
  const CodigosCompartilhamento({super.key});

  @override
  State<CodigosCompartilhamento> createState() => _CodigosCompartilhamentoState();
}
...
class _CodigosCompartilhamentoState extends State<CodigosCompartilhamento> 
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: ShapeDecoration(
                                shape: RoundedRectangleBorder(
                                  side: const BorderSide(color: Color(0xFFBFC8CB)),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(doc['titulo'] ?? '', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
  ...
  void _abrirVisualizarCodigo(Map<String, dynamic> item) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => VisualizarCodigo(codigo: item),
      ),
    );
  }
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(item['codigo'], style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500)),
...
class VisualizarCodigo extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final List<Map<String, String>> documentos = List<Map<String, String>>.from(codigo['documentos'] ?? []);
